...
export default function ComingSoon({
  title = "This Section Is Still Being Prepared",
  description = "This corner of the Arcane Bazaar is still under construction. Check back soon as we continue expanding the marketplace.",
}: ComingSoonProps) {
  return (
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-amber-100/70">
                  The guild is still working on it
                </p>

                <p className="mt-2 text-sm leading-6 text-amber-100/35">
                  We are carefully preparing this section before opening
                  it to adventurers. Thank you for your patience.
                </p>
